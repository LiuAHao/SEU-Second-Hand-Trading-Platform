...
**Windows PowerShell：**
```powershell
cmd /c "chcp 65001 & mysql --default-character-set=utf8mb4 -u root -p seu_second_hand < database\schema_optimized.sql"
```
**macOS/Linux：**
```bash
...
**Windows PowerShell：**
```powershell
cmd /c "chcp 65001 & mysql --default-character-set=utf8mb4 -u root -p seu_second_hand < database\sample_seed.sql"
```
**macOS/Linux：**
```bash
...
## 常用命令
- 迁移旧库：mysql --default-character-set=utf8mb4 -u root -p seu_second_hand < database/migration_v1_to_v2_fixed.sql
